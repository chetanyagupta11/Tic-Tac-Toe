...
public class Winnerdialog extends Dialog {
    ...
    private final PlayActivity mainActivity;
    public Winnerdialog(@NonNull Context context, String message11, Drawable draw,Drawable iconwin) {
        super(context);
        this.message1=message11;
        this.drawabl=draw;
        this.iconwin=iconwin;
        this.mainActivity=((PlayActivity)context);
